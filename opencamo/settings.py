"""
Django settings for opencamo project.
...
SECRET_KEY = 'django-insecure-xdn+ko+om)y2sx^lxvsbs!w$xn7$!^-8_&5^%g=%k=$re@z&uq'
...
WSGI_APPLICATION = 'opencamo.wsgi.application'
